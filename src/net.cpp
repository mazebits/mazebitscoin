...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mazebits " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"mazebitstools.com", "174.138.124.191"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"mazebitstools.com", "testnet-seed.mazebitstools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mazebits is probably already running."), addrBind.ToString().c_str());
        else
